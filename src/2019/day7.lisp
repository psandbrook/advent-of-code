                ...
                (iter (for phase-c from 5 to 9)
                      (iter (for phase-d from 5 to 9)
                            (iter (for phase-e from 5 to 9)
                                  ...
                                  (for amp-a = (make-intcode-computer ints))
                                  (for amp-b = (make-intcode-computer ints))
                                  (for amp-c = (make-intcode-computer ints))
                                  (for amp-d = (make-intcode-computer ints))
                                  (for amp-e = (make-intcode-computer ints))
                                  (run-computer-for-input amp-a phase-a)
                                  (run-computer-for-input amp-b phase-b)
                                  (run-computer-for-input amp-c phase-c)
                                  (run-computer-for-input amp-d phase-d)
                                  (run-computer-for-input amp-e phase-e)

                                  (run-computer-for-input amp-a 0)
                                  (iter
                                    (for sig-a = (run-computer-for-output amp-a))

                                    (run-computer-for-input amp-b sig-a)
                                    (for sig-b = (run-computer-for-output amp-b))

                                    (run-computer-for-input amp-c sig-b)
                                    (for sig-c = (run-computer-for-output amp-c))

                                    (run-computer-for-input amp-d sig-c)
                                    (for sig-d = (run-computer-for-output amp-d))

                                    (run-computer-for-input amp-e sig-d)
                                    (for sig-e = (run-computer-for-output amp-e))

                                    (when (not (run-computer-for-input amp-a sig-e))
